			...
			<View style={[{position:"relative",width:width,height:height},style]}>
				<Svg height={height+lineWidth*2+radius*2} width={width+lineWidth*2+radius*2} style={{position:"absolute",top:y-lineWidth,left:x-lineWidth}}>
					<Defs>
						...
						<RadialGradient id="border-left-top" r="100%" cx="100%" cy="100%" fx="0%" fy="0%">{radial('BoxLeftTop')}</RadialGradient>
						<RadialGradient id="border-left-bottom" r="100%" cx="100%" cy="0%" fx="0%" fy="0%">{radial('BoxLeftBottom')}</RadialGradient>
						<RadialGradient id="border-right-top" r="100%" cx="0%" cy="100%" fx="0%" fy="0%">{radial('BoxRightTop')}</RadialGradient>
